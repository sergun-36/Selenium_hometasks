...
import time
from webdriver_manager.chrome import ChromeDriverManager # для того,чтобы искал драйвер 
...
try:
	browser = webdriver.Chrome(ChromeDriverManager().install()) # с установкой драйвера
	browser.get(url)
